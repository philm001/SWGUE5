...
#include "MeshMergeLibrary.generated.h"
...
struct SWGUE5_API FSkelMeshMergeSectionMapping_BP
{
   GENERATED_BODY()
...
*//*
USTRUCT(BlueprintType)
struct SWGUE5_API FSkelMeshMergeUVTransform
{
...
*
USTRUCT(BlueprintType)
struct SWGUE5_API FSkelMeshMergeUVTransformMapping
{
    GENERATED_BODY()
        /** For each UV channel on each mesh, how the UVS should be transformed. *
        UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Mesh Merge Params")
        TArray < FSkelMeshMergeUVTransforms > UVTransformsPerMesh;
};
/**
* Struct containing all parameters used to perform a Skeletal Mesh merge.
*/
USTRUCT(BlueprintType)
struct SWGUE5_API FSkeletalMeshMergeParams
{
    GENERATED_BODY()
...
*/
UCLASS()
class SWGUE5_API UMeshMergeLibrary : public UBlueprintFunctionLibrary
{
 //   GENERATED_BODY
    GENERATED_BODY()
public:
   ...
   // MeshMergeLibrary(const TArray<FSkelMeshMergeUVTransform>& x) : TArray<FSkelMeshMergeUVTransform>(x) {}
};
